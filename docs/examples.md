...
| Use bundled plugin recipes | [CMIP6-decadal Rook-style Recipe](notebooks/cmip6_decadal_rook_style_example.ipynb), [Atlas Recipe](notebooks/atlas_recipe_example.ipynb), [ESA CCI Recipe](notebooks/esa_cci_recipe_example.ipynb), [xMIP Plugin Demo](notebooks/xmip_plugin_demo.ipynb) |
