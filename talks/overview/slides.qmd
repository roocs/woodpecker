...
# 5. Woodpecker in the CDS {.diagram-small}

**Already in Rook:** shared plugins replace adaptations built into the service.

```{mermaid}
%%{init: {"flowchart": {"htmlLabels": false, "subGraphTitleMargin": {"bottom": 8, "top": 0}}, "fontFamily": "Arial", "fontSize": 24, "htmlLabels": false, "sequence": {"actorFontSize": 24, "fontSize": 24, "messageFontSize": 24, "mirrorActors": false, "noteFontSize": 24}, "theme": "base", "themeVariables": {"actorBkg": "#f3f4f6", "actorBorder": "#6b7280", "actorTextColor": "#111827", "clusterBkg": "#f3f4f6", "clusterBorder": "#6b7280", "edgeLabelBackground": "#ffffff", "fontFamily": "Arial", "fontSize": "24px", "lineColor": "#6b7280", "primaryBorderColor": "#6b7280", "primaryColor": "#f3f4f6", "primaryTextColor": "#111827", "secondaryColor": "#dceef8", "signalColor": "#6b7280", "signalTextColor": "#111827", "tertiaryColor": "#fff3bf"}}}%%
flowchart LR
    D["CMIP6 Decadal plugin"] --> W["Woodpecker"]
    A["Atlas plugin"] --> W
    W --> R["Rook: in production"]
    W -.-> C["Other CDS workflows: to explore"]
    style W fill:#dceef8,stroke:#457b9d,stroke-width:2px
```

- **No extra service:** runs inside existing workflows.
- **Next:** review Decadal adaptations with data producers for the data update.
- **Opportunity:** reuse the same plugins elsewhere in CDS.

**Where in CDS should we try this next?**
...
**First step for CDS:** data producers and service providers review and test the CMIP6 Decadal adaptations together for the upcoming data update.
