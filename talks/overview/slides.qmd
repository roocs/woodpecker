...
# 2. Woodpecker's value for CDS

## Already in use through Rook

Woodpecker replaces adaptations embedded in **Rook and daops** with independently tested and released plugins.

**Production use:** CMIP6 Decadal and Atlas adaptations for the CDS.

## Value for a wider CDS context

- **No additional service:** a lightweight Python package runs within existing workflows.
- **Reuse:** the same plugins can serve Rook, other Python applications, and command-line processing.
- **Clear ownership:** dataset specialists maintain adaptations separately from service code.

**Opportunity:** reduce duplicated adaptation code and maintenance effort across CDS workflows.

---

# 3. The problem: fragmented fixes {.diagram-small}
...
# 4. What does Woodpecker provide? {.diagram-small}
...
# 5. A core fix: Celsius to Kelvin {.diagram-small}
...
# 7. Outlook: broader use within CDS

## Next opportunity: the CMIP6 Decadal data update

**Data producers and service providers** review the existing adaptations together, update the plugin through GitHub, and test a release for operational use.

## Broader CDS use to explore

- **More datasets:** add plugins with the relevant data producers and agree maintenance ownership.
- **Other CDS workflows:** pilot reuse beyond Rook and validate outputs and operational requirements.
- **Discoverable adaptations:** explore catalogue and ESGF Errata references using stable fix identifiers.

**Discussion for CDS:** which workflow and dataset family should we assess first, and who can work with us on it?
